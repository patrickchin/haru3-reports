...
import { createSyncPullRoutes } from "./routes/sync-pull.js";
import { createSyncApplyRoutes } from "./routes/sync-apply.js";
...
export function createApp(options: CreateAppOptions = {}): App {
  ...
  app.route(
    "/v1/sync",
    createSyncPullRoutes({ getSql: options.getSql ?? getSql }),
  );
  app.route(
    "/v1/sync",
    createSyncApplyRoutes({ getSql: options.getSql ?? getSql }),
  );
  app.route(
    "/v1/reports",
